!function(t) {
    ...
    function r(o) {
        ...
        return t[o].call(i.exports, i, i.exports, r),
        i.l = !0,
        i.exports
    }
    r.m = t,
    ...
    !function() {
        ...
        e.createData = function(t, r, o) {
            ...
            if (n.getLengthInBits() > 8 * h)
                throw new Error("code length overflow. (" + n.getLengthInBits() + ">" + 8 * h + ")");
            for (n.getLengthInBits() + 4 <= 8 * h && n.put(0, 4); n.getLengthInBits() % 8 != 0; )
                n.putBit(!1);
            for (; !(n.getLengthInBits() >= 8 * h || (n.put(e.PAD0, 8),
        ...
        e.createBytes = function(t, e) {
            for (var r = 0, o = 0, i = 0, n = new Array(e.length), a = new Array(e.length), s = 0; s < e.length; s++) {
                ...
                var f = g.getErrorCorrectPolynomial(l)
                  , c = new p(n[s],f.getLength() - 1).mod(f);
                a[s] = new Array(f.getLength() - 1);
                for (u = 0; u < a[s].length; u++) {
                    var d = u + c.getLength() - a[s].length;
                    a[s][u] = d >= 0 ? c.get(d) : 0
                }
            }
            var m = 0;
            ...
            for (u = 0; u < o; u++)
                for (s = 0; s < e.length; s++)
                    u < n[s].length && (_[v++] = n[s][u]);
            for (u = 0; u < i; u++)
                for (s = 0; s < e.length; s++)
                    u < a[s].length && (_[v++] = a[s][u]);
            return _
        }
        ;
        for (var r = {
            ...
            getErrorCorrectPolynomial: function(t) {
                for (var e = new p([1],0), r = 0; r < t; r++)
                    e = e.multiply(new p([1, c.gexp(r)],0));
                return e
            },
            ...
            c.EXP_TABLE[d] = 1 << d;
        for (d = 8; d < 256; d++)
            c.EXP_TABLE[d] = c.EXP_TABLE[d - 4] ^ c.EXP_TABLE[d - 5] ^ c.EXP_TABLE[d - 6] ^ c.EXP_TABLE[d - 8];
        for (d = 0; d < 255; d++)
            c.LOG_TABLE[c.EXP_TABLE[d]] = d;
        function p(t, e) {
            if (void 0 == t.length)
        ...
        var w = function() {
          ...
          , D = "svg" === document.documentElement.tagName.toLowerCase() ? w : "undefined" == typeof CanvasRenderingContext2D ? function() {
            ...
            return t.prototype.draw = function(t) {
                ...
                this.cb && this.cb(this._el.getElementsByTagName("table")[0])
            }
            ,
            t.prototype.clear = function() {
                this._el.innerHTML = ""
            ...
            var o = function(t, e, r) {
                ...
                this._elImage.onload = function(t) {
                    r && r(t)
                }
                ,
                this._elImage.onerror = function(t) {
                    r && r(t)
                }
            };
            return o.prototype.draw = function(t) {
                ...
                for (var l = 0; l < i; l++)
                    for (var u = 0; u < i; u++) {
                        ...
                        r.fillRect(g, c, n, a),
                        r.strokeRect(Math.floor(g) + .5, Math.floor(c) + .5, s, h),
                        r.strokeRect(Math.ceil(g) - .5, Math.ceil(c) - .5, s, h)
                    }
                this._bIsPainted = !0
            }
            ,
            o.prototype.makeImage = function() {
                this._bIsPainted && function(t, e, r) {
                    var o = this;
                    if (o._fFail = e,
                    o._fSuccess = t,
        ...
        QRCode = function(t, e, r) {
            ...
            this._el = t,
            this._oQRCode = null,
            this._oDrawing = new D(this._el,this._htOption,this.cb),
        ...
        window.$QRCodeMakerSupport = QRCode,
        window.$QRCodeMaker = function(t, e, r) {
            return new function(t, e, r) {
                ...
                e ? (e.width && (o.width = e.width),
                e.height && (o.height = e.height),
                e.furColor && (o.colorLight = e.furColor),
                e.bgColor && (o.colorDark = e.bgColor),
                e.correct && (o.correctLevel = e.correct)) : e = o,
                new QRCode(this.el,e,function(t) {
